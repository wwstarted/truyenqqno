...
<div id="main_homepage" data-ajax-enabled="true" data-filter-type="truyen-moi">
    <div class="homepage_tags">
        <h1>
            <p class="text_list_update">
                <i class="fa fa-plus-circle" aria-hidden="true"></i> Truyện Mới Đăng
            </p>
        </h1>
        <div class="clear"></div>
    </div>
        ...
        <ul class="list_grid grid">
            ...
            if ($comics_query->have_posts()):
                while ($comics_query->have_posts()):
                    ...
                    $time_ago = human_time_diff(get_the_time('U'), current_time('timestamp')) . ' trước';
            ...
            <li>
                <div class="book_avatar">
                    ...
                    <div class="top-notice">
                        ...
                        <?php if ($is_new): ?>
                        <span class="type-label label-new">Mới</span>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="book_info">
                    ...
                    <div class="text_detail">
                        <span><i class="fa fa-bookmark"></i> <?php echo number_format($follow_count); ?></span>
            ...
            <?php
                ...
                echo '<li class="no-results"><p>Chưa có truyện mới.</p></li>';
            endif;
            ?>
        </ul>
    </div>
