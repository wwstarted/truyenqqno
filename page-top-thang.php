...
// Lấy TẤT CẢ truyện, sắp xếp theo monthly_views
$comic_ids = $wpdb->get_col("
    ...
    ORDER BY COALESCE(s.monthly_views, 0) DESC, 
...
<div id="main_homepage" data-ajax-enabled="true" data-filter-type="top-thang">
    <div class="homepage_tags">
        <h1>
            <p class="text_list_update">
                <i class="fa fa-fire" aria-hidden="true"></i> Top Truyện Tháng
            </p>
        </h1>
        <div class="clear"></div>
    </div>
                        ...
                        <ul class="choose">
                            ...
                            <li>
                                <a class="<?php echo ($status === 'ongoing') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => 'ongoing', 'country' => $country)); ?>">Đang
                                    tiến hành</a>
                            </li>
                            <li>
                                <a class="<?php echo ($status === 'completed') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => 'completed', 'country' => $country)); ?>">Hoàn
                                    thành</a>
                            </li>
                        </ul>
                    </td>
                        ...
                        <ul class="choose">
                            ...
                            <li>
                                <a class="<?php echo ($country === 'China') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => $status, 'country' => 'China')); ?>">Trung
                                    Quốc</a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 'Vietnam') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => $status, 'country' => 'Vietnam')); ?>">Việt
                                    Nam</a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 'Korea') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => $status, 'country' => 'Korea')); ?>">Hàn
                                    Quốc</a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 'Japan') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg(array('status' => $status, 'country' => 'Japan')); ?>">Nhật
                                    Bản</a>
                            </li>
                        </ul>
                    </td>
    ...
    <div class="list_grid_out">
        <ul class="list_grid grid">
            ...
            if ($comics_query->have_posts()):
                ...
                while ($comics_query->have_posts()):
                    ...
                    $view_stats = $wpdb->get_row(
                        $wpdb->prepare(
                            "SELECT monthly_views FROM {$stats_table} WHERE post_id = %d",
                            $post_id
                        )
                    );
                    $view_count = $view_stats ? $view_stats->monthly_views : 0;
            ...
            <?php
                ...
                echo '<li class="no-results"><p>Chưa có dữ liệu lượt xem tháng này.</p></li>';
            endif;
            ?>
        </ul>
    </div>
