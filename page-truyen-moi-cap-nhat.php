...
$country = isset($_GET['country']) ? intval($_GET['country']) : '';
...
// Country filter (for future implementation)
if ($country !== '') {
            ...
            <tbody>
                        ...
                        <ul class="choose">
                            <li>
                                <a class="<?php echo ($status === 'ongoing') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg('status', 'ongoing'); ?>">
                                    Đang tiến hành
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($status === 'completed') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg('status', 'completed'); ?>">
                                    Hoàn thành
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($status === 'coming_soon') ? 'active' : ''; ?>"
                                    href="<?php echo add_query_arg('status', 'coming_soon'); ?>">
                                    Sắp ra mắt
                                </a>
                            </li>
                        </ul>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="choose">
                            <li>
                                <a class="<?php echo ($country === 1) ? 'active' : ''; ?>" title="Truyện Trung Quốc"
                                    href="<?php echo add_query_arg('country', 1); ?>">
                                    Trung Quốc
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 2) ? 'active' : ''; ?>" title="Truyện Việt Nam"
                                    href="<?php echo add_query_arg('country', 2); ?>">
                                    Việt Nam
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 3) ? 'active' : ''; ?>" title="Truyện Hàn Quốc"
                                    href="<?php echo add_query_arg('country', 3); ?>">
                                    Hàn Quốc
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 4) ? 'active' : ''; ?>" title="Truyện Nhật Bản"
                                    href="<?php echo add_query_arg('country', 4); ?>">
                                    Nhật Bản
                                </a>
                            </li>
                            <li>
                                <a class="<?php echo ($country === 5) ? 'active' : ''; ?>" title="Truyện Mỹ"
                                    href="<?php echo add_query_arg('country', 5); ?>">
                                    Mỹ
                                </a>
                            </li>
                        </ul>
