...
<div id="main_homepage" data-ajax-enabled="true" data-filter-type="yeu-thich">
    <div class="homepage_tags">
        <h1>
            <p class="text_list_update">
                <i class="fa fa-heart" aria-hidden="true"></i> Truyện Yêu Thích Nhất
            </p>
        </h1>
        <div class="clear"></div>
    </div>
    ...
    <div class="list_grid_out">
        <ul class="list_grid grid">
            ...
            <?php
                ...
                echo '<li class="no-results"><p>Chưa có dữ liệu.</p></li>';
            endif;
            ?>
        </ul>
    </div>
